...
public class BookScreenC extends BaseOwoScreen<FlowLayout> {

    // Path to the custom background image
    private static final Identifier BACKGROUND_TEXTURE = Identifier.of("mob-buddies", "textures/gui/book_page_c.png");
    ...
    protected void build(FlowLayout rootComponent) {
        ...
        Component leftButtonComponent = ScreenHelper.CreateSummonButton("enderman-buddy", 25);
        Component rightButtonComponent =  ScreenHelper.CreateSummonButton("piglin-buddy", 75);

        Component previousButtonComponent = ScreenHelper.CreateChangeButton("<-", new BookScreenB(), 10);
        Component nextButtonComponent = ScreenHelper.CreateChangeButton(">", new BookScreenD(), 89);
